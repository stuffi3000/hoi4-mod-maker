...
STRINGS: dict[str, str] = {
    ...
    "hint_mode_continent": "Add continent names, then click states to assign them.",
    "hint_mode_country": "Create a country (TAG + name + color), then click states to assign territory.",
    "hint_mode_default_map": "Configure max river count and tree color palette.",
    ...
    "hint_mode_placement": "Generate placement proposals, review the explicit coordinates, and accept only selected records.",
    ...
    "hint_mode_terrain": "Click 'Auto Generate' to assign terrain by height, or paint manually with brushes.",
}
