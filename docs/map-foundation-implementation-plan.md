...
1. Independently test each milestone from a code point of view (do not only rely on the repo tests).
2. If the code is clean, test the features from each milestone on the Belgium project.
...
- [x] **1.4.1 hotfix:** source commit `2986b8b` passed the full suite (1,334 passed, 1 skipped), compilation, diff checks, a clean PyInstaller 6.22.3 build, and an eight-second packaged-GUI smoke test. Release [v1.4.1](https://github.com/stuffi3000/hoi4-mod-maker/releases/tag/v1.4.1) publishes the Windows archive and `SHA256SUMS.txt`; the archive SHA-256 is `0ad138b596e9e6ea8dbb978270131ecbc78fd26faadc876ba5fc1bcd88e94247` and the executable SHA-256 is `7a6676d094ecfe701af2bd95b1b2464a4a424c643697764b873cb453e642d169`.
- [x] **1.4.2 performance bugfix:** source commit `a2b3b8a` passed the full suite (1,334 passed, 1 skipped), compilation, diff checks, a clean PyInstaller 6.22.3 build, and a five-second packaged-GUI smoke test. The Belgium project load path fell from about 51 seconds to about 1.3 seconds. The v1.4.2 Windows archive and `SHA256SUMS.txt` are prepared for [GitHub publication](https://github.com/stuffi3000/hoi4-mod-maker/releases/tag/v1.4.2); the archive SHA-256 is `9904c95dca8d7ab9602f34485cf687fab2cafc7c9ca5227113e7bfca825a4981` and the executable SHA-256 is `d1932b9117baec4909f70ba7593c0e97ef7510787b12bf483b689f9cec31c6b0`. The source/tag push is complete; release-asset publication awaits refreshed GitHub CLI authentication.
- [x] **1.4.3 export/readiness workflow release:** source commit `1bbd2dc` passed the non-game suite (1,371 passed, 4 deselected), compilation, diff checks, a clean PyInstaller 6.22.3 build, and a five-second packaged-GUI smoke test. Release [v1.4.3](https://github.com/stuffi3000/hoi4-mod-maker/releases/tag/v1.4.3) publishes the Windows archive and `SHA256SUMS.txt`; the archive SHA-256 is `a4918eab7ea4348d9a81e6717af7b949c4b1917d5ca95db6c3dbda9e29c48006` and the executable SHA-256 is `91d36977eedc7ca410e718361839ee3f49b1c29448951a67b654fd8b04f77ad0`.

### M10 final engine/freeze checkpoint (updated 2026-09-22)
...
- **Release evidence:** v1.4.1 was built from source commit `2986b8b`, smoke-tested, checksummed, and published with a human-oriented description that links to `CHANGELOG.md`. The v1.4.2 performance package was built from source commit `a2b3b8a`, smoke-tested, checksummed, and prepared with the same release documentation.
- **Remaining Gate E step:** use the placement proposal/review workflow to author and explicitly accept all required province slots and strategic-region weather positions in the Belgium project, regenerate the foundation artifact, and rerun strict freeze plus handoff to close Gate E.
