...
- [x] **1.4.2 performance bugfix:** source commit `a2b3b8a` passed the full suite (1,334 passed, 1 skipped), compilation, diff checks, a clean PyInstaller 6.22.3 build, and a five-second packaged-GUI smoke test. The Belgium project load path fell from about 51 seconds to about 1.3 seconds. Release [v1.4.2](https://github.com/stuffi3000/hoi4-mod-maker/releases/tag/v1.4.2) publishes the Windows archive and `SHA256SUMS.txt`; the archive SHA-256 is `9904c95dca8d7ab9602f34485cf687fab2cafc7c9ca5227113e7bfca825a4981` and the executable SHA-256 is `d1932b9117baec4909f70ba7593c0e97ef7510787b12bf483b689f9cec31c6b0`.
